...
function TimePickerCtrl($scope, $mdDialog, time, autoSwitch, timeBg, $mdMedia) {
	var self = this;
    this.VIEW_HOURS = 1;
    this.VIEW_MINUTES = 2;
    ...
    return {
        ...
        link: function(scope, element, attrs, ctrl) {
            ...
            var onEvent = function(event) {
                ...
                $timeout(function() {
					if(ctrl.timeBg) ctrl.setTimeByDeg(deg + 180);
...
module.provider("$mdpTimePicker", function() {
    ...
    this.$get = ["$mdDialog", function($mdDialog) {
        var timePicker = function(time, options) {
            ...
            return $mdDialog.show({
                controller:  ['$scope', '$mdDialog', 'time', 'autoSwitch', 'timeBg', '$mdMedia', TimePickerCtrl],
                            ...
                            '<md-dialog-content layout-gt-xs="row" layout-wrap>' +
                                ...
                                '<div>' +
                                    '<div class="mdp-clock-switch-container" ng-switch="timepicker.currentView" layout layout-align="center center">' +
	                                    '<mdp-clock class="mdp-animation-zoom" time-bg="timepicker.timeBg" auto-switch="timepicker.autoSwitch" time="timepicker.time" type="hours" ng-switch-when="1"></mdp-clock>' +
	                                    '<mdp-clock class="mdp-animation-zoom" time-bg="timepicker.timeBg" auto-switch="timepicker.autoSwitch" time="timepicker.time" type="minutes" ng-switch-when="2"></mdp-clock>' +
                                    '</div>' +
...
module.directive("mdpTimePicker", ["$mdpTimePicker", "$timeout", function($mdpTimePicker, $timeout) {
    return  {
        ...
        link: function(scope, element, attrs, ngModel, $transclude) {
            ...
            scope.timeBg = scope.timeBg || false;
